...
export function buildMaterialDetailPath(taskId: string, materialId: string) {
  return `/member/materials/${encodeURIComponent(materialId)}?taskId=${encodeURIComponent(taskId)}`;
}
